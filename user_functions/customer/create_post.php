	...
	<div class="container-fluid">
		<form action="" id="manage_post">
			<input type="hidden" name="post_id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="d-flex w-100 align-items-center">
				<div class="rounded-circle mr-1" style="width: 40px;height: 40px;top:-5px;left: -40px">
					<img src="../../<?php echo $_SESSION['login_user_profile_image'] ?>" class="image-fluid image-thumbnail rounded-circle" alt="" style="max-width: calc(100%);height: calc(100%);">
				</div>
				<div class="ml-4 text-left" style="width:calc(80%)">
					<div><small><?php echo ucwords($_SESSION['login_user_name']) ?></small></div>
					<input type="hidden" name="post_type" value="<?php echo isset($type) ? $type : 0 ?>">
					<div class="dropdown">
			...
			<div class="form-group">
				<textarea name="post_content" id="content" cols="30" rows="2" class="form-control" placeholder="What's on your mind, <?php echo ucwords($_SESSION['login_user_name']) ?>?" style="resize:none;border: none"><?php echo isset($content) ? $content : '' ?></textarea>
			</div>
			<div class="c-row" id="">
