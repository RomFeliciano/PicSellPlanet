<?php
    ...
    function lensman_add($user_type, $fullname, $email, $user_sex, $address, $birthday, $contact_num, $id_type, $id_image_path, $bLicense_path, $pfp_image_path, $password, $cPassword)
    {
                ...
                if(check_age($birthday))
                {
                    if(check_password("length", $password, $cPassword))
                    {
                        if(check_password("match", $password, $cPassword))
                        {
                            ...
                            if($myRegister->insertLensmanData($user_type, $fullname, $email, $user_sex, $address, $birthday, $contact_num, $id_type, $id_image_path, $bLicense_path, $pfp_image_path, $hashed_password, $v_code) && sendMail($email, $v_code))
                            {
                                return true;
                            }
                            else
